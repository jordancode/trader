...
class Accumulate(strategy.Strategy):
    ...
    def get_parameters(cls):
        return [
            ...
            ("amount", float, "How much currency (in base_currency units) to accumulate every interval."),
            ("interval_secs", int, "how long do we wait between purchases") 
        ]
